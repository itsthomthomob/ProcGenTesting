...
//===========================================================================//
// MODIFICATIONS:
// - 03/06: Modified controls so the player has to hold down left-mouse button to move
//          allows the mouse to be used for selecting objects
//
//
//
//
...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    private void SetCursorState()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            // Check if the left mouse button has been held down for more than 0.2 seconds
            if (timeHeld >= 0.2f)
            {
